<div id="content" class="col-sm-9">
    ...
    <div class="owl-carousel latest_category_carousel">
        @foreach($category->getallchildren() as $cat)
        <div class="product-thumb">
            <div class="image">
                <a href="{{Route("shop.product_detail.show",$cat)}}">
                    <img src="{{str_replace("public","/storage",$cat->img01_address)}}" alt="کرم مو آقایان" title="کرم مو آقایان" class="img-responsive" /></a></div>

            <div class="caption">
                <h4><a href="product.html">{{$cat->title}}</a></h4>
                <p class="price"> {{$cat->price}} تومان </p>
                <div class="rating"> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> </div>
            </div>
            <div class="button-group">
                <button class="btn-primary" type="button" onClick=""><span>افزودن به سبد</span></button>
    ...
    <div id="carousel" class="owl-carousel nxt">
        ...
        <div class="item text-center">
            <a href="">
                <img src="{{str_replace("public","/storage",$br->img_address)}}" alt="پالم" class="img-responsive" />
            </a>
        </div>
        @endforeach
    </div>
