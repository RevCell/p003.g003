                ...
                <div id="content" class="col-sm-9">
                    <div itemscope itemtype="http://schema.org/محصولات">
                        ...
                        <div class="row product-info">
                            <div class="col-sm-6">
                                <div class="image"><img class="img-responsive" itemprop="image" id="zoom_01" src="{{str_replace("public","/storage",$product->img01_address)}}" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" data-zoom-image="image/product/macbook_air_1-500x500.jpg" /> </div>
                                ...
                                <div class="image-additional" id="gallery_01">
                                    <a class="thumbnail" href="#" data-zoom-image="image/product/macbook_air_1-500x500.jpg" data-image="image/product/macbook_air_1-350x350.jpg" title="لپ تاپ ایلین ور">
                                        <img src="{{str_replace("public","/storage",$product->img02_address)}}" title="لپ تاپ ایلین ور" alt = "لپ تاپ ایلین ور"/>
                                    </a>
                                    <a class="thumbnail" href="#" data-zoom-image="image/product/macbook_air_4-500x500.jpg" data-image="image/product/macbook_air_4-350x350.jpg" title="لپ تاپ ایلین ور">
                                        <img src="" title="" alt="" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <ul class="price-box">
                                    <li class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer"><span class="price-old">19/000/000 تومان</span> <span itemprop="price">{{$product->price}} تومان<span itemprop="availability" content="موجود"></span></span></li>
                                    <li></li>
...
@section("scripts")
    <script type="text/javascript" src="/shop/js/jquery.elevateZoom-3.0.8.min.js"></script>
    <script type="text/javascript" src="/shop/js/swipebox/lib/ios-orientationchange-fix.js"></script>
    <script type="text/javascript" src="/shop/js/swipebox/src/js/jquery.swipebox.min.js"></script>
